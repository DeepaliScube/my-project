                                        ...
                                        <div class="grid gap-5 lg:gap-7.5">
                                                        ...
                                                        <div class="lg:col-span-1">
                                                                <div
                                                                        ...
                                                                        <div
                                                                                ...
                                                                                <div
                                                                                        class="flex flex-col gap-1 pb-4 px-5">
                                                                                        <span
                                                                                                class="text-3xl font-semibold text-mono">
                                                                                                9.3k
                                                                                        </span>
                                                                                        <span
                                                                ...
                                                                <div class="kt-card h-full h-full">
                                                                        <div
                                                                                ...
                                                                                <div
                                                                                        ...
                                                                                        <h2
                                                                                                class="text-xl font-semibold text-mono">
                                                                                                Connect Today & Join
                                                                                                <br />
                                                                                                the
                                                                                                <a class="kt-link"
                                                                                        ...
                                                                                        <p
                                                                                                class="text-sm font-normal text-secondary-foreground leading-5.5">
                                                ...
                                                <div class="grid lg:grid-cols-3 gap-5 lg:gap-7.5 items-stretch">
                                                        <div class="lg:col-span-1">
                                                                <div class="kt-card h-full">
                                                                        ...
                                                                        <div
                                                                                class="kt-card-content flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
                                                                                ...
                                                                                <div
                                                                                        ...
                                                                                        <div
                                                                                                class="bg-green-500 h-2 w-full max-w-[60%] rounded-xs">
                                                                                        </div>
                                                                                        <div
                                                                                                class="bg-destructive h-2 w-full max-w-[25%] rounded-xs">
                                                                                        </div>
                                                                                        <div
                                                                                                class="bg-violet-500 h-2 w-full max-w-[15%] rounded-xs">
                                                                                        </div>
                                                                                </div>
                                                                                <div
                                                                                        class="flex items-center flex-wrap gap-4 mb-1">
                                                                                        <div
                                                                                                class="flex items-center gap-1.5">
                                                                                                <span
                                                                                                        class="rounded-full size-2 rounded-full kt-badge-success">
                                                                                                </span>
                                                                                                <span
                                                                                        ...
                                                                                        <div
                                                                                                class="flex items-center gap-1.5">
                                                                                                <span
                                                                                                        class="rounded-full size-2 rounded-full kt-badge-destructive">
                                                                                                </span>
                                                                                                <span
                                                                                                        class="text-sm font-normal text-foreground">
                                                                                                        Bundle
                                                                                        ...
                                                                                        <div
                                                                                                class="flex items-center gap-1.5">
                                                                                                <span
                                                                                                        class="rounded-full size-2 rounded-full kt-badge-info">
                                                                                                </span>
                                                                                                <span
                                                                                                        class="text-sm font-normal text-foreground">
                                                                                                        MetronicNest
                                                                                ...
                                                                                <div class="grid gap-3">
                                                                                        <div
                                                                                                ...
                                                                                                <div
                                                                                                        class="flex items-center gap-1.5">
                                                                                                        <i
                                                                                                                class="ki-filled ki-shop text-base text-muted-foreground">
                                                                                                        </i>
                                                                                                        <span
                                                                                                                class="text-sm font-normal text-mono">
                                                                                                                Online
                                                                                                                Store
                                                                                                        </span>
                                                                                                </div>
                                                                                                <div
                                                                                                        class="flex items-center text-sm font-medium text-foreground gap-6">
                                                                                                        <span
                                                                                                                class="lg:text-right">
                                                                                                                $172k
                                                                                                        </span>
                                                                                                        <span
                                                                                                                class="lg:text-right">
                                                                                                                <i
                                                                                                                        class="ki-filled ki-arrow-up text-green-500">
                                                                                                                </i>
                                                                                                                3.9%
                                                                                                        </span>
                                                                                                </div>
                                                                                        ...
                                                                                        <div
                                                                                                ...
                                                                                                <div
                                                                                                        class="flex items-center gap-1.5">
                                                                                                        <i
                                                                                                                class="ki-filled ki-facebook text-base text-muted-foreground">
                                                                                                        </i>
                                                                                                        <span
                                                                                                                class="text-sm font-normal text-mono">
                                                                                                                Facebook
                                                                                                ...
                                                                                                <div
                                                                                                        ...
                                                                                                        <span
                                                                                                                class="lg:text-right">
                                                                                                                <i
                                                                                                                        class="ki-filled ki-arrow-down text-destructive">
                                                                                                                </i>
                                                                                                                0.7%
                                                                                                        </span>
                                                                                                </div>
                                                                                        ...
                                                                                        <div
                                                                                                ...
                                                                                                <div
                                                                                                        class="flex items-center gap-1.5">
                                                                                                        <i
                                                                                                                class="ki-filled ki-instagram text-base text-muted-foreground">
                                                                                                        </i>
                                                                                                        <span
                                                                                                                class="text-sm font-normal text-mono">
                                                                                                                Instagram
                                                        ...
                                                        <div class="lg:col-span-2">
                                                                <div class="kt-card h-full">
                                                                        ...
                                                                        <div
                                                                                class="kt-card-content flex flex-col justify-end items-stretch grow px-3 py-1">
                                                ...
                                                <div class="grid lg:grid-cols-3 gap-5 lg:gap-7.5 items-stretch">
                                                        <div class="lg:col-span-1">
                                                                <div class="kt-card h-full">
                                                                        <div
                                                                                class="kt-card-content lg:p-7.5 lg:pt-6 p-5">
                                                                                <div
                                                                                        class="flex items-center justify-between flex-wrap gap-5 mb-7.5">
                                                                                        <div
                                                                                ...
                                                                                <p
                                                                                        class="text-sm font-normal text-foreground leading-5.5 mb-8">
                                                                                        Team meeting to discuss
                                                                                        strategies, outline
                                                                                        <br />
                                                                                        project milestones, define key
                                                                                        goals, and
                                                                                        <br />
                                                                                        establish clear timelines.
                                                                                </p>
                                                                                <div
                                                                                        class="flex rounded-lg bg-accent/50 gap-10 p-5">
                                                                                        <div
                                                                                                class="flex flex-col gap-5">
                                                                                                <div
                                                                                                        class="flex items-center gap-1.5 text-sm font-normal text-foreground">
                                                                                                        <i
                                                                                                                class="ki-filled ki-geolocation text-base text-muted-foreground">
                                                                                                        </i>
                                                                                                        Location
                                                                                                </div>
                                                                                                <div
                                                                                                        class="text-sm font-medium text-foreground pt-1.5">
                                                                                                        Amsterdam
                                                                                                </div>
                                                                                        </div>
                                                                                        <div
                                                                                                ...
                                                                                                <div
                                                                                                        class="flex items-center gap-1.5 text-sm font-normal text-foreground">
                                                                                                        <i
                                                                                                                class="ki-filled ki-users text-base text-muted-foreground">
                                                                                                        </i>
                                                                                                        Team
                                                                                                </div>
                                                                                                <div
                                                                                ...
                                                                                <div class="kt-card-table">
                                                                                        <div class="grid"
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                                ...
                                                                                                                                <td>
                                                                                                                                        <div
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                        class="kt-rating-label indeterminate">
                                                                                                ...
                                                                                                <div
                                                                                                        ...
                                                                                                        <div
                                                                                                                class="flex items-center gap-4 order-1 md:order-2">
                                                                                                                <span
